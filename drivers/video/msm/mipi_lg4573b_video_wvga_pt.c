...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db = {
    ...
    {0xae, 0x2a, 0x15, 0x00, 0x91, 0x93, 0x1a, 0x2a, 0x19, 0x03, 0x04, 0xa0},
    {0x5f, 0x00, 0x00, 0x10},
    {0xff, 0x00, 0x06, 0x00},
    {0x0, 0x65, 0xb1, 0xda, 0x00, 0x50, 0x48, 0x63, 0x31, 0x0f, 0x07, 0x00, 0x14, 0x03, 0x00, 0x02, 0x00, 0x20, 0x00, 0x01},
};
...
static int __init mipi_video_lg4573b_wvga_pt_init(void)
{
	...
	if (msm_fb_detect_client("mipi_video_lg4573b_wvga"))
		return 0;
#endif
...
subsys_initcall_sync(mipi_video_lg4573b_wvga_pt_init);
#else
