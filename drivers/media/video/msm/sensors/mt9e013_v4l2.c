...
static struct sensor_afcalib_data mt9e013_afcalib_data;
static struct sensor_wbcalib_data mt9e013_wbcalib_data;
static struct sensor_lenscalib_data mt9e013_lcalib_data;

static struct msm_camera_eeprom_read_t mt9e013_eeprom_read_tbl[] = {
	{0x3834, &mt9e013_afcalib_data.af_pos_typ_inf, 8, 1},
	{0x3831, &mt9e013_wbcalib_data.r_over_g, 6, 1},
	{0x3835, &mt9e013_lcalib_data.lsc_data[0], 375, 0},
	{0x3836, &mt9e013_lcalib_data.lsc_data[375], 375, 0},
	{0x3837, &mt9e013_lcalib_data.lsc_data[750], 355, 0},
};

static struct msm_camera_eeprom_data_t mt9e013_eeprom_data_tbl[] = {
	{&mt9e013_afcalib_data, sizeof(struct sensor_afcalib_data)},
	{&mt9e013_wbcalib_data, sizeof(struct sensor_wbcalib_data)},
	{&mt9e013_lcalib_data, sizeof(struct sensor_lenscalib_data)},

};

static void mt9e013_set_eeprom_pageaddr
	(struct msm_camera_eeprom_client *ectrl, uint16_t *paddr)
{
	int rc = 0;
	int16_t temp_read;
	uint16_t page = (*paddr & 0x00FF) << 8;
...
static struct msm_camera_eeprom_client mt9e013_eeprom_client = {
	.i2c_client = &mt9e013_sensor_i2c_client,
	.i2c_addr = 0x6C,
...
static struct msm_sensor_ctrl_t mt9e013_s_ctrl = {
	...
	.sensor_eeprom_client = &mt9e013_eeprom_client,
