...
#define C811_STD_ID_MIN 412 
#define C811_STD_ID_MAX 479
#define C811_EXT_ID_MIN 682
#define C811_EXT_ID_MAX 769
...
static int set_battery_data(struct pm8921_bms_chip *chip)
{
	...
	if (is_between(C811_STD_ID_MIN, C811_STD_ID_MAX, battery_id)) {
		goto c811_std;
	} else if (is_between(C811_EXT_ID_MIN, C811_EXT_ID_MAX,	battery_id)) {
		goto c811_ext;
	} else {
