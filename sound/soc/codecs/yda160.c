...
static int DVE073_yda160_amp_event(struct snd_soc_dapm_widget *w,
...
static int DVE073_yda160_voice_amp_event(struct snd_soc_dapm_widget *w,
					 struct snd_kcontrol *k, int event)
{
	struct yda160_priv *yda160 = i2c_get_clientdata(yda160_i2c_client);
...
static const struct snd_soc_dapm_widget yda160_dapm_widgets[] = {
	SND_SOC_DAPM_SPK("YDA160 Amp Spk", DVE073_yda160_amp_event),
	SND_SOC_DAPM_SPK("ES310 voice", DVE073_yda160_voice_amp_event),
};

static const struct snd_soc_dapm_route yda160_audio_map[] = {
	{"YDA160 Amp Spk", NULL, "LINEOUT2"},
	{"ES310 voice", NULL, "LINEOUT1"},
};
...
MODULE_DESCRIPTION("I2C bus driver for DVE072 External Audio Devices");
