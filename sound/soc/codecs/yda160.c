...
#if 0 
static void yda160_amp_power_on(void)
{
	yda160_amp_init_info();
	D4Np2_PowerOn(&yda160_amp_info);
	
	
	yda160_amp_set_path(YDA160_AMP_MONO_IN_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_LINE1_IN_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_LINE2_IN_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_RECV_IN_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_HP_OUT_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_SP_OUT_PATH, 0);
	yda160_amp_set_path(YDA160_AMP_RECV_OUT_PATH, 0);
	yda160_amp_update_info();	

	yda160_amp_power_on_f = true;
}
#endif
...
int yda160_add_controls(struct snd_soc_codec *codec)
{
	...
	return snd_soc_add_controls(codec, yda160_controls,
			ARRAY_SIZE(yda160_controls));

#if 0
	return snd_soc_add_controls(codec, es310_controls,
...
#else
# define yda160_audio_i2c_suspend NULL
# define yda160_audio_i2c_resume  NULL
#endif
